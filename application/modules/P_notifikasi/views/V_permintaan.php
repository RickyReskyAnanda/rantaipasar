<div class="row wrapper border-bottom white-bg page-heading">
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1"><i class="fa fa-user"></i> Permintaan</a></li>
                            </ul>
        ...
        <script type="text/javascript">
            ...
            function ambilData(){
                $.ajax({
                    url: "<?=base_url().'P_notifikasi/select_data_permintaan'?>",
            ...
            function persetujuan(status,identitas){
                swal({
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?=base_url().'P_notifikasi/update_status_data_permintaan'?>",
